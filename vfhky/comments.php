...
<?php if ($comments) : ?>
	<h3 id="comments">《<?php echo mb_strimwidth(get_the_title(),0,52,……); ?>》目前共有<?php comments_number('', ' 1 条留言', ' % 条留言' );?></h3>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<div id="comment-author-info">
		...
		<p>
			...
			<label for="email">邮箱<?php if ($req) echo " *"; ?> （<a title="查看如何申请一个自己的Gravatar全球通用头像" target="_blank" href="http://www.huangkeye.com/archives/5.html">用于显示个性头像</a>）</label>
		</p>
		<p>
